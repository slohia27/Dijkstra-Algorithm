...
public class Display extends JFrame {
  ...
  private JComboBox weightedStartCityComboBox;
  private JComboBox weightedEndCityComboBox;
  ...
  public Display() {
    ...
    dijkstra = readGraph("src/cityxy.txt", "src/citypairs.txt");
    ...
    txtCityxytxt.setText("src/cityxy.txt");
    ...
    txtCitypairstxt.setText("src/citypairs.txt");
    ...
    btnDrawWeightedShortest.addMouseListener(new MouseAdapter() {
      @Override
      public void mouseReleased(MouseEvent e) {
        String startCity = (String) weightedStartCityComboBox.getItemAt(weightedStartCityComboBox.getSelectedIndex());
        String endCity = (String) weightedEndCityComboBox.getItemAt(weightedEndCityComboBox.getSelectedIndex());
